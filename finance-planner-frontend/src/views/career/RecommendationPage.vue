        ...
        >
          <GlassCard hoverable>
            ...
            <div class="detail-items">
              <div
                v-if="rec.estimatedMonthlyIncome"
                class="detail-item"
              >
      ...
      >
        ...
        >
          ...
          <n-form-item label="副业类型">
            <n-input
              v-model:value="adoptForm.careerType"
              disabled
            />
          </n-form-item>
          <n-form-item label="描述">
            <n-input
              v-model:value="adoptForm.description"
              type="textarea"
          ...
          <n-form-item label="开始日期">
            <n-date-picker
              v-model:value="adoptForm.startDate"
              type="date"
              style="width: 100%"
            />
          </n-form-item>
        ...
        <template #footer>
          <n-space justify="end">
            <n-button @click="showAdoptDialog = false">
              取消
            </n-button>
            <n-button
              type="primary"
