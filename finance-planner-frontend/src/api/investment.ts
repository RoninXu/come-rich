...
export function getAssessmentHistory() {
  return request.get<ApiResponse<RiskAssessment[]>>('/investment/assessment/history')
}

export function generateRecommendations() {
  return request.post<ApiResponse<InvestmentAdvice>>('/investment/recommendations')
}

export function getActiveRecommendations() {
  return request.get<ApiResponse<InvestmentRecommendation[]>>('/investment/recommendations')
}
