...
export function exportTransactionsExcel(startDate: string, endDate: string, type?: number, categoryId?: number) {
...
export function exportTransactionsCsv(startDate: string, endDate: string, type?: number, categoryId?: number) {
